...
const Navbar = () => {
  return (
    ...
    <div className="container-fluid">
      <Link className="navbar-brand" to="/">Vocabulary Book App</Link>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
          <Link className="nav-link active" to="/about">Hakkımızda</Link>
          </li>
         
          <li className="nav-item">
          <Link className="nav-link active" to="/contact">İletişim</Link>
          </li> */}
        </ul>
